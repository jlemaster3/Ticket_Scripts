...
output_directory = "C:\\Users\\jlemaster3\\OneDrive - Gainwell Technologies\\Documents\\_Ticket_Repo\\RITM0176143\\removed_005_006"


output_log_file = "C:\\Users\\jlemaster3\\OneDrive - Gainwell Technologies\\Documents\\_Ticket_Repo\\RITM0176143\\MSXIX_removeing_old_005_006_ws_log.txt"
    ...
    for _stream_id in range(len(_stream_start_ids)):
        ...
        for _t in search_terms:
            if _t in _source_lines[_stream_idx]:
                ...
                _remove = True
        if _remove == False:
            for _i in range(_stream_idx, _stream_end +2):
