...
source_dir = "C:\\VS_Managed_Accounts\\KSXIX\\PROD"
...
output_log_file = "C:\\Users\\jlemaster3\\OneDrive - Gainwell Technologies\\Documents\\_Ticket_Repo\\RITM0150789\\PROD_2_PPS_log.txt"
...
if __name__ == "__main__":
    _file_list_A = get_jil_files(source_dir)
    _missing_from_B = get_diff_filePaths_A_B (_file_list_A, output_directory)
    _copy_log = copy_to_path(_missing_from_B,source_dir, output_directory)
