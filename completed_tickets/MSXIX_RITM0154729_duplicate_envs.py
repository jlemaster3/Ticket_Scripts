...
source_directory = "C:\\VS_Managed_Accounts\\MSXIX\\PROD"

# where the output files shold go, dont use source location
output_directory = "C:\\Users\\jlemaster3\\OneDrive - Gainwell Technologies\\Documents\\_Ticket_Repo\\RITM0154729\\Diffrences"
...
find_replace_strings = {
    "@APP1#" :"@APP3#",
    "@APP2#" :"@APP4#",
    "MSICXRHPRDAP001" : "msicxrhprdap005",
    "MSICXRHPRDAP002" : "msicxrhprdap006",
    "APP001": "AP005",
    "AP002": "AP006"
}
...
def process_files (path_list:list, seach_replace_dictionary:dict, output_path:str, overwrite_original:bool=False, keep_original:bool=False, original_to_DRAFT:bool=False, original_to_NOP:bool=False, changed_to_DRAFT:bool=False, changed_to_NOP:bool=True,):
