...
class ToolBox_ECS_Node (UserDict):
    """Base Node for all Node classes

    This Node tpye is a generic and basic node that trcks an ID, Name, and simple dictionary data.
    This node manages a basic Hierarchal connections to Children Nodes.
    """
    #------- public properties -------#
