...
source_directory = "C:\\Users\\jlemaster3\\OneDrive - Gainwell Technologies\\Documents\\_Ticket_Repo\\RITM0150789\\PBC_from_UATC"

# where the output files shold go, dont use source location
output_directory = "C:\\Users\\jlemaster3\\OneDrive - Gainwell Technologies\\Documents\\_Ticket_Repo\\RITM0150789\\PBC_path_corrections"

output_log_file = "C:\\Users\\jlemaster3\\OneDrive - Gainwell Technologies\\Documents\\_Ticket_Repo\\RITM0150789\\PBC_MACH8_DOCOMMAND_log.txt"
...
find_replace_strings = {
    "autojob.sh":"/dsks/{APP_CMN}/{ENV_DIR}/autojob.sh",
...
def process_files (path_list:list, seach_replace_dictionary:dict, output_path:str, overwrite_original_file:bool=False, keep_original_Stream:bool=False, original_to_DRAFT:bool=False, original_to_NOP:bool=False, changed_to_DRAFT:bool=False, changed_to_NOP:bool=True,):
    ...
    for counter, filePath in enumerate(path_list):
        ...
        try:    
            ...
            _msg_str = f" [{counter+1}] - Error processing file : {os.path.basename(filePath)} - {e}"
            print (_msg_str)
            _output_log_holder.append(_msg_str)
