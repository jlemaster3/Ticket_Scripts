...
output_log_file = "C:\\Users\\jlemaster3\\OneDrive - Gainwell Technologies\\Documents\\_Ticket_Repo\\IDXIX_SITALT_to_UATALT\\_step_2_copy_SITALT_log.txt"
...
if __name__ == "__main__":
    ...
    copiedPathList = copy_files(
        sourceFileList = _file_list_A,
        output_path= _output_jobs_A,
        exclude_dir=[]
    )
