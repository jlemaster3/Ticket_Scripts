...
class ToolBox_REGEX_Patterns (StrEnum):
    ...
    YEAR_MONTH_DAY = r'(?P<year>\d{4})(?P<month>\d{2})(?P<day>\d{2})\,?'
    ...
    IWS_ON_DATE_LINE = r'(?:[Oo][Nn])(?![Rr][Uu][Nn][Cc][Yy][Cc][Ll][Ee])\s*(?:(?P<year>\d{4})(?P<month>\d{2})(?P<day>\d{2}))'
    ...
    IWS_VALIDTO = r'(?P<to_valid_from>[Vv][Aa][Ll][Ii][Dd][Tt][Oo]|[Vv][Aa][Ll][Ii][Dd][Ff][Rr][Oo][Mm])\s*(?P<year>\d{4})(?P<month>\d{2})(?P<day>\d{2})'
    IWS_VALIDFROM = r'(?P<to_valid_from>[Vv][Aa][Ll][Ii][Dd][Tt][Oo]|[Vv][Aa][Ll][Ii][Dd][Ff][Rr][Oo][Mm])\s*(?P<year>\d{4})(?P<month>\d{2})(?P<day>\d{2})'
